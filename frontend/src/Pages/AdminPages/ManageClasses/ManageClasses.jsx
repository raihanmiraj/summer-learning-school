...
<div className="btn-group">
  ...
  <label for="feedbackbtnmodal" onClick={()=>feedbackBtnHanlder(e._id)}  class="btn  btn-xs bg-blue-600 border-none" disabled={e.status=='denied'?false:true}>Feedback</label>
</div>
</td>
       </tr>
 </> 
